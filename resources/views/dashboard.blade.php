<x-app-layout>
    ...
    class="relative z-10 bg-white dark:bg-gray-800 w-auto">
    <div class="relative">
        <ul class="flex items-center justify-center dark:text-white flex-1 p-1 space-x-1 list-none border rounded-md text-neutral-700 group dark:border-gray-800 border-neutral-200/80">
            <li>
                <button
